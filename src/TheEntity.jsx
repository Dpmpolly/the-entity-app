      ...
      <div className="max-w-xl mx-auto px-4 py-6 pb-24">
        ...
        <div className="grid grid-cols-2 gap-2 mb-8">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-3">
                ...
                {playerHasCrafted && <div className="mt-2 text-center text-[10px] text-emerald-400 animate-pulse font-bold">COMPONENTS ASSEMBLED</div>}
            </div>
                 ...
                 <div className="flex gap-1">
                    ...
                    >
                        ...
                        <span className="text-[9px] bg-slate-950 px-1.5 py-0.5 rounded text-slate-300 border border-slate-800 uppercase tracking-wider">
                            {playerHasCrafted ? "CRAFTED" : isEmpFree ? "FREE" : canDeployEmp ? `READY (x${empAmmo})` : "$1.00"}
                        </span>
                    </button>
