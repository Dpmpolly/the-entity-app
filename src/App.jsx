  ...
  const syncStravaActivities = async () => {
      ...
      try {
          ...
          const newRuns = activities
            .filter(act => act.type === 'Run') // Ensure we only get runs
            .map(act => {
          ...
          if (newRuns.length > 0) {
              ...
              alert("No new runs found (filtered for 'Run' type).");
          }
